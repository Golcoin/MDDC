...
#ifndef H_MODERCASH_SCRIPT
#define H_MODERCASH_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMODERCASHAddress
 */
...
public:
    ...
    // Pre-version-0.6, MODERCASH always counted CHECKMULTISIGs
