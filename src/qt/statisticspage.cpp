...
void StatisticsPage::updateStatistics()
{
    ...
    QString phase = "";
    if (pindexBest->nHeight < 2629800)
    {
        phase = "POW - POS";
    }
    else if (pindexBest->nHeight > 2629800)
    {
        phase = "POS";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " MDDC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " MDDC" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " MDDC");
    }
