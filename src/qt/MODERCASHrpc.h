...
#ifndef _modercashrpc_H_
#define _modercashrpc_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // MODERCASH is not connected
...
/**
 * MODERCASH RPC command dispatcher.
 */
class CRPCTable
{
private:
